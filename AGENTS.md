...
- Preserve the `/seiyuu` context path, API contracts, Jikan rate limits, resumable refresh behavior, and API-key secrecy unless an approved change explicitly revises them.
